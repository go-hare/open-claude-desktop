...
const FRONTMOST_GATE_DESC = "The frontmost application must be in the session allowlist at the time of this call, or this tool returns an error and does nothing.";
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            click_x: {
              type: "integer",
              description: "X coordinate to click after activation (client-area). If omitted, clicks center of window."
            },
            click_y: {
              type: "integer",
              description: "Y coordinate to click after activation (client-area). If omitted, clicks center of window."
            }
          },
          required: []
        }
